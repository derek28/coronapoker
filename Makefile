...
OBJ     = main.o pokerhand.o card.o deck.o player.o game.o strength.o misc.o human_player.o random_player.o ehs_player.o
OBJTEST = test.o pokerhand.o card.o deck.o player.o game.o strength.o misc.o human_player.o random_player.o
OBJHUMANVSBOT = humanvsbot.o pokerhand.o card.o deck.o player.o game.o strength.o misc.o human_player.o random_player.o ehs_player.o
